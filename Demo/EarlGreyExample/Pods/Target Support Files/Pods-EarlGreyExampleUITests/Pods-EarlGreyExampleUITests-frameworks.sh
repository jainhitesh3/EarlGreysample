...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LotameDMP/LotameDMP.framework"
  install_framework "${PODS_ROOT}/MOGeofence/MOGeofence/MOGeofence.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NSString+Validation/NSString_Validation.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EarlGreyTest/EarlGreyTest.framework"
